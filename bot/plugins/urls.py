...
async def _(c, m):
    ...
    snt = await m.reply_text(
        "<i>Hi there, Please wait while I'm getting everything ready to process your request!</i>",
        quote=True,
    )
    ...
    if isinstance(duration, str):
        await snt.edit_text("😟 Sorry! I cannot open the file. contact <b>~@world_wide_movies</b>")
